  ...
  THEMEMASCOT.bmiCalculator = {
    magic: function (bmi) {
      ...
      if (bmi) {
        ...
        output =
          "Your BMI is <span>" + bmi + "</span><br />" + "You are <span>" + info + "</span>.";
      } else {
        output = "You broke it!";
      }
      return output;
      ...
      if (!THEMEMASCOT.isMobile.any() && $window.width() >= 800) {
        $(".parallax").each(function () {
          var data_parallax_ratio =
            $(this).data("parallax-ratio") === undefined ? "0.5" : $(this).data("parallax-ratio");
      ...
      if ($piechart.length > 0) {
        ...
        $document_body.on("appear", ".piechart", function () {
          ...
          if (!current_item.hasClass("appeared")) {
            ...
            var linewidth =
              current_item.data("linewidth") === undefined ? "3" : current_item.data("linewidth");
      ...
      if ($twitter_feed_carousel.length > 0) {
        $twitter_feed_carousel.twittie(
          ...
          function () {
            ...
            var data_dots =
              $this_carousel.data("dots") === undefined ? false : $this_carousel.data("dots");
            var data_nav =
              $this_carousel.data("nav") === undefined ? false : $this_carousel.data("nav");
            var data_duration =
    ...
    TM_owlCarousel: function () {
      ...
      if ($owl_carousel_1col.length > 0) {
        ...
        $owl_carousel_1col.each(function () {
          ...
          var data_duration =
            $(this).data("duration") === undefined ? 4000 : $(this).data("duration");
          $(this).owlCarousel({
            rtl: THEMEMASCOT.isRTL.check(),
            autoplay: true,
            autoplayTimeout: data_duration,
    ...
    TM_beforeAfterSlider: function () {
      ...
      if ($before_after_slider.length > 0) {
        $before_after_slider.each(function () {
          var $this = $(this);
          var data_offset_pct =
            $this.data("offset-percent") === undefined ? 0.5 : $this.data("offset-percent");
          var data_orientation =
            $this.data("orientation") === undefined ? "horizontal" : $this.data("orientation");
          var data_before_label =
            $this.data("before-label") === undefined ? "Before" : $this.data("before-label");
          var data_after_label =
            $this.data("after-label") === undefined ? "After" : $this.data("after-label");
          var data_no_overlay =
            $this.data("no-overlay") === undefined ? true : $this.data("no-overlay");
          $this.twentytwenty({
